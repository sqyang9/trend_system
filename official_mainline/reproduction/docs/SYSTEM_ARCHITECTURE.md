...
flowchart TD
    ...
    E2["S1 ATRVT 90d + VP gate"] --> E
    H1["RangeRotation scaled to 1.00"] --> H
    H2["S2 ATRVT 60d"] --> H
    I1["Sell-side EMA250"] --> I
    I2["Stable RE close3 / HC RE strict+breakout4 / HV85 force / Weekly override"] --> I
...
- runtime scaling: `ATRVT_90D_med_035_150`
- adopted gate: `S1_VP_LB60_EA050_VR120`
...
- runtime scaling: `ATRVT_60D_med_035_150`
...
- high-churn forcing: `HV percentile >= 85`
