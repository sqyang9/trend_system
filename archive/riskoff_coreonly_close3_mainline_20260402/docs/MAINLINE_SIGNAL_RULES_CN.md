...
- 含义：`core_target > 0`
- 运行上分两档：
  - `full = 1.0 unit`，组合映射成 `Core = 0.75`
  - `soft_off = 0.5 unit`，组合映射成 `Core = 0.375`
...
- `S1B` = bullish breakout + squeeze release + quality filter 通过
