...
ADOPTED_POSTURE = {
    "id": "adopted_posture_core0.75_s11.25_s21.00",
    "core_weight": 0.75,
    "sleeve1_weight": 1.25,
    "sleeve2_weight": 1.00,
}
...
def playbook_text(pkg: Dict) -> str:
    lines = [
        ...
        "- Adopted running posture: `Core 0.75 / Sleeve1 1.25 / Sleeve2 1.00`.",
        "- Risk-Off overlay: sell-side `EMA250`, re-entry `Weekly RSI(14) <= 30 hold`.",
        "",
