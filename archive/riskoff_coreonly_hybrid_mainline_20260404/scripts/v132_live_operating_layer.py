...
ADOPTED_POSTURE = {
    "id": "adopted_posture_core1.00_s11.00_s21.00",
    "core_weight": 1.00,
    "sleeve1_weight": 1.00,
    "sleeve2_weight": 1.00,
}
...
def playbook_text(pkg: Dict) -> str:
    lines = [
        ...
        "- Risk-Off overlay: sell-side `EMA250`, stable re-entry `close3`, high-churn re-entry `strict EMA50 + breakout_4`, override `Weekly RSI(14) <= 30 hold`.",
        "",
...
def build_html(pkg: Dict) -> str:
    ...
    fig.update_layout(
        ...
        title=(
            ...
            f"Onboarding={pkg['preferred_onboarding']}</sup>"
        ),
    )
