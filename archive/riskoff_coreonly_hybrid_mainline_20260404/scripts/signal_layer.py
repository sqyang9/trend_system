...
def build_signal_snapshot() -> Dict:
    ...
    core_trace = build_target_trace(riskoff_ind, ADOPTED_SPEC, instability["instability_state"])
    core_target_unit = core_trace["weight"].astype(float)
    ...
    payload = {
        ...
        "recent_ohlc": recent_4h[["open", "high", "low", "close", "ema250", "ema50", "core_target", "core_gate", "core_instability_state", "s1_weight", "s2_weight"]],
