...
- Adopted promoted version: `Formal + ATRVT_S1S2 + EMA250_CLOSE3_HC23_STRICT_BREAKOUT4_HV85FORCE`.
...
- Current-time onboarding audit:
  ...
  - current background state `ATR scale 1.00 / HV pct 92.0 / instability source hv_force`
