...
- This is the retained sell-side audit that settled `EMA250`.
- Its old weekly-branch wording is historical; the current adopted re-entry is `close3 / HC23 strict breakout_4 / weekly override`.
