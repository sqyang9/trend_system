...
- Mainline freeze rule:
  - the current official mainline is locked
  - reserve challengers must clear promotion audit, landing audit, implementation parity, and doc sync before replacement
...
- The former `S1 volume-profile proxy gate` reserve line has been promoted into the official mainline.
...
- Runtime / governance companions:
  - verification: `MAINLINE_RUNTIME_VERIFICATION.md`
  - monitoring: `MAINLINE_MONITORING_CHECKLIST.md`
...
- current asymmetric sleeve scaling:
  - `S1 = ATRVT_90D_med_035_150`
  - `S2 = ATRVT_60D_med_035_150`
